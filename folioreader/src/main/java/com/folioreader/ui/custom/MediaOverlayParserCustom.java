...
public class MediaOverlayParserCustom {
     ...
     */
    public static void parseMediaOverlay(EpubPublicationCustom publication, Container container) throws EpubParserException {
     ...
     */
    private static void parseSequences(Element body, MediaOverlayNode node, EpubPublicationCustom publication, String href) throws StackOverflowError {
     ...
     */
    private static void addMediaOverlayToSpine(EpubPublicationCustom publication, MediaOverlayNode node, int position) {
     ...
     */
    private static int getPosition(List<CustomLink> spines, String baseHref) {

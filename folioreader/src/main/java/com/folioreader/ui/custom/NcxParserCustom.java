...
import org.readium.r2_streamer.parser.NCXParser;
...
public class NcxParserCustom {
    ...
    public static void parseNCXFile(String ncxFile, Container container, EpubPublicationCustom publication, String rootPath) throws EpubParserException {
